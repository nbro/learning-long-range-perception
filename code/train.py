...
"""Train the neural network get_model using the given training set."""
...
def train():
	"""Train the neural network get_model, save the weights and shows the learning error over time."""
	...
	parser.add_argument('-learning_rate', '--learning-rate', type=float, help='learning rate used for the training phase', default=0.0002)
